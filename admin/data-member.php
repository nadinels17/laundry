...
$query = mysqli_query($konek, "SELECT * FROM tb_customer");
                            ...
                            <table class="table mt-5 mx-2" style=" background-color: #89CFF0;">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td><?=$data["member"];?></td>
                                        <td>
                                            <a class="btn btn-success" href="action/update-member.php?id=<?=$data["id_member"];?>">
                                            ...
                                            <a class="btn btn-danger" href="action/delete-member.php?id=<?=$data["id_member"];?>">
